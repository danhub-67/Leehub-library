...
function LeehHub:CreateWindow(config)
	...
	local function RebuildThemeFX()
		...
		if n == "Galaxy" then
			for i = 1, 55 do
				spawnDot(ThemeFXLayer, math.random(1, 3), math.random(), math.random(), Color3.fromRGB(255, 255, 255), math.random(10, 50) / 100)
			end
			for i = 1, 12 do
				spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), math.random(), Color3.fromRGB(167, 139, 250), math.random(40, 70) / 100)
			end
		elseif n == "Inferno" then
			...
			for i = 1, 20 do
				spawnDot(ThemeFXLayer, math.random(2, 5), math.random(), 0.7 + math.random() * 0.25, Color3.fromRGB(255, 80, 0), math.random(30, 60) / 100)
			end
		elseif n == "Ocean" then
			for i = 1, 35 do
				local sz = math.random(3, 8)
				spawnDot(ThemeFXLayer, sz, math.random(), math.random(), Color3.fromRGB(0, 200, 180), math.random(45, 75) / 100)
			end
			for i = 1, 15 do
				spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), 0.6 + math.random() * 0.35, Color3.fromRGB(100, 220, 255), math.random(50, 80) / 100)
			end
		elseif n == "Sakura" then
			for i = 1, 30 do
				...
				petal.Position = UDim2.new(math.random(), 0, math.random(), 0)
				...
				petal.BackgroundTransparency = math.random(25, 55) / 100
		...
		elseif n == "Arctic" or n == "GlassFrost" then
			for i = 1, 45 do
				spawnDot(ThemeFXLayer, math.random(2, 5), math.random(), math.random(), Color3.fromRGB(255, 255, 255), math.random(20, 60) / 100)
			end
			for i = 1, 10 do
				spawnDot(ThemeFXLayer, math.random(3, 6), math.random(), math.random(), Color3.fromRGB(180, 220, 255), math.random(40, 70) / 100)
			end
		elseif n == "Matrix" then
			for i = 1, 50 do
				local col = Instance.new("Frame")
				col.Size = UDim2.fromOffset(2, math.random(8, 28))
				col.Position = UDim2.new(math.random(), 0, math.random() * 0.7, 0)
				col.BackgroundColor3 = Color3.fromRGB(0, 255, 65)
				col.BackgroundTransparency = math.random(30, 70) / 100
		...
		elseif n == "Bloodmoon" then
			for i = 1, 25 do
				spawnDot(ThemeFXLayer, math.random(2, 6), math.random(), math.random(), Color3.fromRGB(180, 0, 20), math.random(35, 65) / 100)
			end
		...
		elseif n == "Sunset" then
			for i = 1, 20 do
				spawnDot(ThemeFXLayer, math.random(4, 12), math.random(), 0.15 + math.random() * 0.4, Color3.fromRGB(255, 120 + math.random(0, 80), 80), math.random(50, 80) / 100)
			end
		elseif n == "Toxic" then
			for i = 1, 30 do
				spawnDot(ThemeFXLayer, math.random(2, 6), math.random(), math.random(), Color3.fromRGB(200, 255, 0), math.random(40, 70) / 100)
			end
		elseif n == "NeonOrange" or n == "NeonPink" or n == "NeonCyan" or n == "NeonPurple" or n == "NeonLime" then
			local c = Theme.Accent
			for i = 1, 28 do
				spawnDot(ThemeFXLayer, math.random(1, 4), math.random(), math.random(), c, math.random(40, 75) / 100)
			end
		elseif n == "Synthwave" or n == "Vaporwave" or n == "Cyberpunk" then
			for i = 1, 20 do
				spawnDot(ThemeFXLayer, math.random(2, 5), math.random(), math.random(), Theme.Accent, math.random(45, 75) / 100)
			end
			for i = 1, 12 do
				spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), math.random(), Theme.Outline, math.random(50, 80) / 100)
			end
		elseif n == "Blackout" then
			for i = 1, 15 do
				spawnDot(ThemeFXLayer, 1, math.random(), math.random(), Color3.fromRGB(160, 160, 170), math.random(60, 85) / 100)
			end
		elseif n == "Aurora" then
			for i = 1, 18 do
				spawnDot(ThemeFXLayer, math.random(3, 8), math.random(), math.random() * 0.5, (i % 2 == 0) and Color3.fromRGB(34, 211, 238) or Color3.fromRGB(167, 139, 250), math.random(55, 85) / 100)
			end
		elseif n == "Royal" then
			for i = 1, 20 do
				spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), math.random(), Color3.fromRGB(245, 197, 66), math.random(40, 70) / 100)
			end
		elseif n == "EmeraldGlass" then
			for i = 1, 18 do
				spawnDot(ThemeFXLayer, math.random(2, 5), math.random(), math.random(), Color3.fromRGB(16, 185, 129), math.random(50, 80) / 100)
			end
		elseif n == "GlassRose" or n == "GlassObsidian" then
			for i = 1, 12 do
				spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), math.random(), Theme.Outline, math.random(55, 85) / 100)
			end
		else
			ThemeFXLayer.Visible = false
		end
	...
	if resolvedOpenIcon ~= "" then
		...
		fIconHolder.Size = UDim2.fromScale(0.86, 0.86)
			...
			function Section:CreateDropdown(dConfig)
				...
				local function build()
					...
					for i, opt in ipairs(options) do
						...
						ob.Text = (multi and (isOn and "  ✓  " or "     ") or "  ") .. txt
