...
LeehHub.ThemeOrder = {"Aurora", "NeonPurple", "NeonCyan", "NeonPink", "NeonLime", "NeonOrange", "Synthwave", "Cyberpunk", "Toxic", "GlassFrost", "GlassObsidian", "GlassRose", "Bloodmoon", "EmeraldGlass", "Royal", "Arctic", "Vaporwave", "Blackout", "Galaxy"}
...
function LeehHub:CreateWindow(config)
	...
	FloatBtn.BackgroundTransparency = 0.12
	FloatBtn.Text = ""
	...
	local FloatStroke = AddStroke(FloatBtn, Theme.Accent, 3, 0.05)
	...
	if resolvedOpenIcon ~= "" then
		...
		fIcon.Size = resolvedOpenIconIsCustom and UDim2.fromScale(0.92, 0.92) or UDim2.fromScale(0.52, 0.52)
