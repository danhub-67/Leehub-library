...
function LeehHub:CreateWindow(config)
	...
	Overlay.BackgroundTransparency = (hasBgImage or hasBgVideo) and 0.55 or 1
	...
	local function RebuildThemeFX()
		...
		if n == "Galaxy" then
			for i = 1, 60 do
				local d = spawnDot(ThemeFXLayer, math.random(1, 3), math.random(), math.random(), Color3.fromRGB(255, 255, 255), math.random(10, 55) / 100)
				Twinkle(d, 0.4, 1.5, 4)
			end
			for i = 1, 14 do
				local d = spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), math.random(), Color3.fromRGB(167, 139, 250), math.random(40, 65) / 100)
				Twinkle(d, 0.35, 2, 5)
				Drift(d, 0.04, 0.04, 6, 12)
			end
			for i = 1, 3 do
				local nebula = spawnDot(ThemeFXLayer, math.random(80, 140), math.random() * 0.8, math.random() * 0.8, Color3.fromRGB(124, 58, 237), 0.88)
				Drift(nebula, 0.06, 0.06, 10, 18)
			end

		elseif n == "Inferno" then
			for i = 1, 46 do
		...
		elseif n == "Ocean" then
			for i = 1, 40 do
				...
				local bubble = spawnDot(ThemeFXLayer, sz, math.random(), 1.05, Color3.fromRGB(0, 200, 180), math.random(45, 70) / 100)
				Fall(bubble, 1.05, -0.05, 4, 9)
			end
			for i = 1, 16 do
				local shimmer = spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), math.random(), Color3.fromRGB(100, 220, 255), math.random(50, 75) / 100)
				Twinkle(shimmer, 0.5, 1.5, 3.5)
				Drift(shimmer, 0.03, 0.02, 5, 9)
			end

		elseif n == "Sakura" then
			for i = 1, 34 do
				local petal = Instance.new("Frame")
				local s = math.random(4, 9)
				petal.Size = UDim2.fromOffset(s, math.floor(s * 0.6))
				petal.Position = UDim2.new(math.random(), 0, -0.05, 0)
				petal.Rotation = math.random(0, 360)
				petal.BackgroundColor3 = (i % 2 == 0) and Color3.fromRGB(255, 183, 197) or Color3.fromRGB(255, 240, 245)
				petal.BackgroundTransparency = math.random(25, 50) / 100
				petal.BorderSizePixel = 0
				petal.ZIndex = 2
				petal.Parent = ThemeFXLayer
				AddCorner(s, petal)
				Fall(petal, -0.05, 1.05, 5, 11)
				Drift(petal, 0.12, 0.01, 2, 4)
			end

		elseif n == "Arctic" or n == "GlassFrost" then
			for i = 1, 50 do
				local flake = spawnDot(ThemeFXLayer, math.random(2, 5), math.random(), -0.05, Color3.fromRGB(255, 255, 255), math.random(20, 55) / 100)
				Fall(flake, -0.05, 1.05, 6, 13)
				Drift(flake, 0.05, 0.01, 2, 4)
			end
			for i = 1, 10 do
				local shine = spawnDot(ThemeFXLayer, math.random(3, 6), math.random(), math.random(), Color3.fromRGB(180, 220, 255), math.random(40, 65) / 100)
				Twinkle(shine, 0.45, 1.5, 3)
			end
		...
		elseif n == "Bloodmoon" then
			for i = 1, 30 do
				local d = spawnDot(ThemeFXLayer, math.random(2, 6), math.random(), math.random(), Color3.fromRGB(180, 0, 20), math.random(35, 60) / 100)
				Twinkle(d, 0.45, 1.5, 3.5)
			end
			local moon = Instance.new("Frame")
			moon.Size = UDim2.fromOffset(28, 28)
			moon.Position = UDim2.new(0.82, 0, 0.08, 0)
			moon.BackgroundColor3 = Color3.fromRGB(196, 30, 58)
			moon.BackgroundTransparency = 0.35
			moon.BorderSizePixel = 0
			moon.ZIndex = 2
			moon.Parent = ThemeFXLayer
			AddCorner(14, moon)
			Pulse(moon, 0.3, 0.5, 2.2)
			local glow = Instance.new("Frame")
			glow.Size = UDim2.fromOffset(44, 44)
			glow.Position = UDim2.new(0.82, -8, 0.08, -8)
			glow.BackgroundColor3 = Color3.fromRGB(196, 30, 58)
			glow.BackgroundTransparency = 0.75
			glow.BorderSizePixel = 0
			glow.ZIndex = 1
			glow.Parent = ThemeFXLayer
			AddCorner(22, glow)
			Pulse(glow, 0.6, 0.85, 2.5)

		elseif n == "Sunset" then
			for i = 1, 24 do
				local glow = spawnDot(ThemeFXLayer, math.random(4, 14), math.random(), 0.15 + math.random() * 0.4, Color3.fromRGB(255, 120 + math.random(0, 80), 80), math.random(50, 75) / 100)
				Pulse(glow, 0.5, 0.8, 2 + math.random())
				Drift(glow, 0.02, 0.02, 5, 9)
			end
			local sun = spawnDot(ThemeFXLayer, 50, 0.5, 0.62, Color3.fromRGB(255, 200, 90), 0.55)
			Pulse(sun, 0.45, 0.65, 3)

		elseif n == "Toxic" then
			for i = 1, 36 do
				local d = spawnDot(ThemeFXLayer, math.random(2, 6), math.random(), math.random(), Color3.fromRGB(200, 255, 0), math.random(40, 65) / 100)
				Twinkle(d, 0.5, 1.2, 3)
				Drift(d, 0.03, 0.03, 4, 8)
			end
			for i = 1, 12 do
				local bubble = spawnDot(ThemeFXLayer, math.random(3, 7), math.random(), 1.05, Color3.fromRGB(150, 220, 0), math.random(35, 55) / 100)
				Fall(bubble, 1.05, -0.05, 5, 10)
			end

		elseif n == "NeonOrange" or n == "NeonPink" or n == "NeonCyan" or n == "NeonPurple" or n == "NeonLime" then
			local c = Theme.Accent
			for i = 1, 34 do
				local d = spawnDot(ThemeFXLayer, math.random(1, 4), math.random(), math.random(), c, math.random(40, 70) / 100)
				Twinkle(d, 0.5, 1, 2.6)
				Drift(d, 0.025, 0.025, 4, 8)
			end
			for i = 1, 6 do
				local glow = spawnDot(ThemeFXLayer, math.random(30, 60), math.random(), math.random(), c, 0.85)
				Pulse(glow, 0.78, 0.92, 2.5)
			end

		elseif n == "Synthwave" or n == "Vaporwave" or n == "Cyberpunk" then
			for i = 1, 24 do
				local d = spawnDot(ThemeFXLayer, math.random(2, 5), math.random(), math.random() * 0.6, Theme.Accent, math.random(45, 70) / 100)
				Twinkle(d, 0.5, 1.2, 3)
			end
			for i = 1, 14 do
				local d = spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), math.random() * 0.6, Theme.Outline, math.random(50, 75) / 100)
				Twinkle(d, 0.55, 1.4, 3.4)
			end
			for i = 1, 5 do
				local line = Instance.new("Frame")
				line.Size = UDim2.new(1, 0, 0, 1)
				line.Position = UDim2.new(0, 0, 0.62 + (i * 0.06), 0)
				line.BackgroundColor3 = Theme.Accent
				line.BackgroundTransparency = 0.5 + (i * 0.08)
				line.BorderSizePixel = 0
				line.ZIndex = 2
				line.Parent = ThemeFXLayer
			end

		elseif n == "Blackout" then
			for i = 1, 26 do
				local d = spawnDot(ThemeFXLayer, 1, math.random(), math.random(), Color3.fromRGB(170, 170, 180), math.random(55, 85) / 100)
				Twinkle(d, 0.65, 1.5, 4)
			end

		elseif n == "Aurora" then
			for i = 1, 26 do
				local d = spawnDot(ThemeFXLayer, math.random(3, 8), math.random(), math.random() * 0.5, (i % 2 == 0) and Color3.fromRGB(34, 211, 238) or Color3.fromRGB(167, 139, 250), math.random(55, 80) / 100)
				Pulse(d, 0.5, 0.78, 2 + math.random())
				Drift(d, 0.05, 0.03, 6, 11)
			end
			for i = 1, 18 do
				local star = spawnDot(ThemeFXLayer, 1, math.random(), math.random(), Color3.fromRGB(255, 255, 255), math.random(30, 60) / 100)
				Twinkle(star, 0.4, 1, 2.6)
			end

		elseif n == "Royal" then
			for i = 1, 26 do
				local d = spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), math.random(), Color3.fromRGB(245, 197, 66), math.random(40, 65) / 100)
				Twinkle(d, 0.48, 1.5, 3.5)
			end
			for i = 1, 6 do
				local glow = spawnDot(ThemeFXLayer, math.random(40, 70), math.random(), math.random(), Color3.fromRGB(139, 92, 246), 0.88)
				Pulse(glow, 0.8, 0.92, 3)
			end

		elseif n == "EmeraldGlass" then
			for i = 1, 24 do
				local d = spawnDot(ThemeFXLayer, math.random(2, 5), math.random(), math.random(), Color3.fromRGB(16, 185, 129), math.random(45, 70) / 100)
				Twinkle(d, 0.52, 1.4, 3.4)
				Drift(d, 0.03, 0.03, 5, 9)
			end

		elseif n == "GlassRose" or n == "GlassObsidian" then
			for i = 1, 20 do
				local d = spawnDot(ThemeFXLayer, math.random(2, 4), math.random(), math.random(), Theme.Outline, math.random(55, 78) / 100)
				Twinkle(d, 0.6, 1.6, 3.8)
				Drift(d, 0.02, 0.02, 6, 10)
			end
	...
	AddStroke(ThemePopup, Theme.Outline, 2, 0.12)
	...
	local function UpdateTheme(name, animate)
		...
		local function Apply()
			...
			local hackerThemes = { Matrix = true, Cyberpunk = true, Toxic = true, Blackout = true }
			local existingGrad = MainFrame:FindFirstChild("HackerGradient")
			if hackerThemes[T.Name] then
				...
				elseif T.Name == "Cyberpunk" then
					existingGrad.Color = ColorSequence.new({
						ColorSequenceKeypoint.new(0, Color3.fromRGB(40, 10, 40)),
						ColorSequenceKeypoint.new(0.5, Color3.fromRGB(60, 20, 10)),
						ColorSequenceKeypoint.new(1, Color3.fromRGB(30, 10, 40)),
					})
				elseif T.Name == "Toxic" then
					existingGrad.Color = ColorSequence.new({
						ColorSequenceKeypoint.new(0, Color3.fromRGB(5, 30, 10)),
						ColorSequenceKeypoint.new(1, Color3.fromRGB(15, 50, 20)),
					})
				else
					existingGrad.Color = ColorSequence.new({
						ColorSequenceKeypoint.new(0, Color3.fromRGB(5, 15, 5)),
			...
			for _, item in ipairs(Registered) do
				if item.Type == "TabBtn" then
					if item.Active then
						...
						item.Instance.BackgroundTransparency = 0.08
						if item.Stroke then item.Stroke.Color = T.Accent end
						if item.Stroke then item.Stroke.Transparency = 0.02 end
						if item.Stroke then item.Stroke.Thickness = 2.8 end
						...
						if item.Stroke then item.Stroke.Transparency = 0.12 end
						if item.Stroke then item.Stroke.Thickness = 2.2 end
	...
	function Window:CreateTab(tabConfig, maybeIcon)
		...
		AddCorner(8, tabBtn)
		local tabStroke = AddStroke(tabBtn, Theme.Outline, 2.2, 0.12)
		AddGlassShine(tabBtn, 8)
		...
		local function Activate()
			for _, item in ipairs(Registered) do
				if item.Type == "TabBtn" then
					...
					if item.Stroke then TW(item.Stroke, 0.15, { Color = Theme.Outline, Transparency = 0.12, Thickness = 2.2 }) end
			...
			tabData.Active = true
			page.Visible = true
			TW(tabBtn, 0.15, { BackgroundColor3 = Theme.Accent, BackgroundTransparency = 0.08 })
			if tabStroke then TW(tabStroke, 0.15, { Color = Theme.Accent, Transparency = 0.02, Thickness = 2.8 }) end
		...
		local function RegisterRow(height)
			...
			frame.Parent = page
			AddCorner(8, frame)
			local stroke = AddStroke(frame, Theme.Outline, 2, 0.18)
		...
		function Tab:CreateSection(secConfig)
			...
			function Section:CreateTextArea(taConfig)
				...
				container2.BackgroundTransparency = 0.32
				container2.ZIndex = 6
				container2.Parent = container
				AddCorner(8, container2)
				local stroke2 = AddStroke(container2, Theme.Outline, 2, 0.18)
				AddGlassShine(container2, 8)
		...
		function Tab:CreateSearch(sConfig)
			...
			searchRow.BackgroundTransparency = 0.25
			searchRow.ZIndex = 6
			searchRow.LayoutOrder = -100
			searchRow.Parent = page
			AddCorner(8, searchRow)
			AddStroke(searchRow, Theme.Outline, 2, 0.18)
