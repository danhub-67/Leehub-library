...
LeehHub.Themes.Aurora = MakeTheme("Aurora", "#22D3EE", "#67E8F9", "#A78BFA", "#22D3EE", "#A5F3FC", "#7DD3FC", "#020617", "#0B1220", "#67E8F9")
LeehHub.Themes.NeonPurple = MakeTheme("NeonPurple", "#D946EF", "#E879F9", "#C026D3", "#A21CAF", "#F5D0FE", "#D8B4FE", "#0A0614", "#1A0B2E", "#E879F9")
LeehHub.Themes.NeonCyan = MakeTheme("NeonCyan", "#06B6D4", "#22D3EE", "#0891B2", "#0E7490", "#A5F3FC", "#67E8F9", "#02141A", "#0A1F28", "#22D3EE")
LeehHub.Themes.NeonPink = MakeTheme("NeonPink", "#F472B6", "#F9A8D4", "#EC4899", "#DB2777", "#FCE7F3", "#F9A8D4", "#1A0A14", "#2A1220", "#F9A8D4")
LeehHub.Themes.NeonLime = MakeTheme("NeonLime", "#A3E635", "#D9F99D", "#84CC16", "#65A30D", "#ECFCCB", "#BEF264", "#0A1408", "#142A0E", "#D9F99D")
LeehHub.Themes.NeonOrange = MakeTheme("NeonOrange", "#FB923C", "#FDBA74", "#F97316", "#EA580C", "#FFEDD5", "#FDBA74", "#1A0C04", "#2A1608", "#FDBA74")
LeehHub.Themes.Synthwave = MakeTheme("Synthwave", "#F472B6", "#C084FC", "#8B5CF6", "#EC4899", "#F5D0FE", "#E9D5FF", "#0F0618", "#1E0B2E", "#C084FC")
LeehHub.Themes.Cyberpunk = MakeTheme("Cyberpunk", "#FACC15", "#F472B6", "#FDE047", "#EAB308", "#FEF08A", "#FDE047", "#0C0A04", "#1A1608", "#FDE047")
LeehHub.Themes.Toxic = MakeTheme("Toxic", "#4ADE80", "#86EFAC", "#22C55E", "#16A34A", "#BBF7D0", "#86EFAC", "#04140A", "#0A2214", "#86EFAC")
LeehHub.Themes.GlassFrost = MakeTheme("GlassFrost", "#38BDF8", "#BAE6FD", "#7DD3FC", "#0EA5E9", "#E0F2FE", "#BAE6FD", "#061018", "#0C1C2A", "#BAE6FD")
LeehHub.Themes.GlassObsidian = MakeTheme("GlassObsidian", "#A1A1AA", "#E4E4E7", "#D4D4D8", "#71717A", "#F4F4F5", "#D4D4D8", "#09090B", "#18181B", "#E4E4E7")
LeehHub.Themes.GlassRose = MakeTheme("GlassRose", "#FB7185", "#FECDD3", "#FDA4AF", "#F43F5E", "#FFE4E6", "#FECDD3", "#1A0A0E", "#2A1218", "#FECDD3")
LeehHub.Themes.Bloodmoon = MakeTheme("Bloodmoon", "#EF4444", "#FCA5A5", "#DC2626", "#B91C1C", "#FEE2E2", "#FCA5A5", "#140606", "#220A0A", "#FCA5A5")
LeehHub.Themes.EmeraldGlass = MakeTheme("EmeraldGlass", "#34D399", "#A7F3D0", "#10B981", "#059669", "#D1FAE5", "#6EE7B7", "#04140F", "#0A2218", "#A7F3D0")
LeehHub.Themes.Royal = MakeTheme("Royal", "#FBBF24", "#DDD6FE", "#A78BFA", "#F59E0B", "#FEF3C7", "#C4B5FD", "#0C0A14", "#1A1428", "#DDD6FE")
LeehHub.Themes.Arctic = MakeTheme("Arctic", "#38BDF8", "#E0F2FE", "#7DD3FC", "#0EA5E9", "#F0F9FF", "#BAE6FD", "#040C14", "#0A1824", "#E0F2FE")
LeehHub.Themes.Vaporwave = MakeTheme("Vaporwave", "#F472B6", "#5EEAD4", "#2DD4BF", "#EC4899", "#FCE7F3", "#99F6E4", "#0C0614", "#180E24", "#5EEAD4")
LeehHub.Themes.Blackout = MakeTheme("Blackout", "#22C55E", "#86EFAC", "#4ADE80", "#16A34A", "#DCFCE7", "#BBF7D0", "#020402", "#0A1208", "#86EFAC")
LeehHub.Themes.Galaxy = MakeTheme("Galaxy", "#A78BFA", "#60A5FA", "#8B5CF6", "#3B82F6", "#E0E7FF", "#C4B5FD", "#05020F", "#0C0820", "#93C5FD")
LeehHub.Themes.Sunset = MakeTheme("Sunset", "#FB923C", "#FDBA74", "#F97316", "#EA580C", "#FFEDD5", "#FDBA74", "#1A0A04", "#2A1408", "#FDBA74")
LeehHub.Themes.Ocean = MakeTheme("Ocean", "#0EA5E9", "#38BDF8", "#0284C7", "#0369A1", "#E0F2FE", "#7DD3FC", "#020B14", "#0A1A28", "#38BDF8")
LeehHub.Themes.Sakura = MakeTheme("Sakura", "#F9A8D4", "#FBCFE8", "#F472B6", "#EC4899", "#FDF2F8", "#F9A8D4", "#1A0C12", "#2A1520", "#FBCFE8")
LeehHub.Themes.Inferno = MakeTheme("Inferno", "#F97316", "#FBBF24", "#EF4444", "#DC2626", "#FEF3C7", "#FDBA74", "#140604", "#220C08", "#FBBF24")
LeehHub.Themes.Matrix = MakeTheme("Matrix", "#22C55E", "#4ADE80", "#16A34A", "#15803D", "#DCFCE7", "#86EFAC", "#020A04", "#06140A", "#4ADE80")
...
function LeehHub:CreateWindow(config)
	...
	StarsLayer.Size = UDim2.fromScale(1, 1)
	StarsLayer.BackgroundTransparency = 1
	StarsLayer.ZIndex = 2
	StarsLayer.Visible = false
	StarsLayer.ClipsDescendants = true
	StarsLayer.Parent = MainFrame
	AddCorner(12, StarsLayer)

	local function RebuildStars()
		for _, ch in ipairs(StarsLayer:GetChildren()) do
			if ch:IsA("Frame") then ch:Destroy() end
		end
		if Theme.Name ~= "Galaxy" then
			StarsLayer.Visible = false
			return
		end
	...
	local function UpdateTheme(name, animate)
		...
		Theme = T
		if RebuildStars then RebuildStars() end
