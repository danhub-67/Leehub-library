...
for _, iconUrl in ipairs(IconSources) do
...
LeehHub.CurrentLanguage = "en"
LeehHub.Translations = {
	en = {
		CloseWindow = "Close Window",
		CannotReverse = "You cannot reverse this.",
		Cancel = "Cancel",
		Confirm = "Confirm",
		Select = "Select...",
		...
		TypeOrPaste = "Type or paste here...",
	},
	es = {
		CloseWindow = "Cerrar ventana",
		CannotReverse = "No puedes revertir esto.",
		Cancel = "Cancelar",
		Confirm = "Confirmar",
		Select = "Seleccionar...",
		TypePlaceholder = "Escribir...",
		SearchPlaceholder = "Buscar...",
		Done = "Listo",
		None = "Ninguno",
		SelectedCount = "%d seleccionados",
		TypeOrPaste = "Escribe o pega aqui...",
	},
	pt = {
		CloseWindow = "Fechar janela",
		CannotReverse = "Voce nao pode reverter isto.",
		Cancel = "Cancelar",
		Confirm = "Confirmar",
		Select = "Selecionar...",
		...
		Done = "Concluido",
		None = "Nenhum",
		SelectedCount = "%d selecionados",
		TypeOrPaste = "Digite ou cole aqui...",
	},
	fr = {
		CloseWindow = "Fermer la fenetre",
		CannotReverse = "Vous ne pouvez pas annuler ceci.",
		Cancel = "Annuler",
		Confirm = "Confirmer",
		Select = "Selectionner...",
		TypePlaceholder = "Taper...",
		SearchPlaceholder = "Rechercher...",
		Done = "Termine",
		None = "Aucun",
		SelectedCount = "%d selectionnes",
		TypeOrPaste = "Tapez ou collez ici...",
	},
	de = {
		CloseWindow = "Fenster schliessen",
		CannotReverse = "Dies kann nicht ruckgangig gemacht werden.",
		Cancel = "Abbrechen",
		Confirm = "Bestatigen",
		Select = "Auswahlen...",
		...
		Done = "Fertig",
		None = "Keine",
		SelectedCount = "%d ausgewahlt",
		TypeOrPaste = "Hier tippen oder einfugen...",
	},
	it = {
		CloseWindow = "Chiudi finestra",
		CannotReverse = "Non puoi annullare questa azione.",
		Cancel = "Annulla",
		Confirm = "Conferma",
		Select = "Seleziona...",
		...
		Done = "Fatto",
		None = "Nessuno",
		SelectedCount = "%d selezionati",
		TypeOrPaste = "Scrivi o incolla qui...",
	},
	ru = {
		CloseWindow = "Zakryt okno",
		CannotReverse = "Eto nelzya otmenit.",
		Cancel = "Otmena",
		Confirm = "Podtverdit",
		Select = "Vybrat...",
		TypePlaceholder = "Vvod...",
		SearchPlaceholder = "Poisk...",
		Done = "Gotovo",
		None = "Net",
		SelectedCount = "%d vybrano",
		TypeOrPaste = "Vvedite ili vstavte...",
	},
	zh = {
		CloseWindow = "Guanbi chuangkou",
		CannotReverse = "Ci caozuo wufa chexiao.",
		Cancel = "Quxiao",
		Confirm = "Queren",
		Select = "Xuanze...",
		TypePlaceholder = "Shuru...",
		SearchPlaceholder = "Sousuo...",
		Done = "Wancheng",
		None = "Wu",
		SelectedCount = "Yixuan %d xiang",
		TypeOrPaste = "Zai ci shuru huo zhantie...",
	},
	ja = {
		CloseWindow = "Mado o tojiru",
		CannotReverse = "Kore wa moto ni modosenai.",
		Cancel = "Kyanseru",
		Confirm = "Kakunin",
		Select = "Sentaku...",
		TypePlaceholder = "Nyuryoku...",
		SearchPlaceholder = "Kensaku...",
		Done = "Kanryo",
		None = "Nashi",
		SelectedCount = "%d sentaku-chu",
		TypeOrPaste = "Kokoni nyuryoku matawa haritsuke...",
	},
	ko = {
		CloseWindow = "Chang dagi",
		CannotReverse = "Igeoseul doedolril su eopseumnida.",
		Cancel = "Chwiso",
		Confirm = "Hwagin",
		Select = "Seontaek...",
		TypePlaceholder = "Ibnyeok...",
		SearchPlaceholder = "Geomsaek...",
		Done = "Wallyo",
		None = "Eopseum",
		SelectedCount = "%d gae seontaekdoem",
		TypeOrPaste = "Yeogie ipryeok hageona butyeo neoeuseyo...",
	},
	ar = {
		CloseWindow = "Ighlaq al-nafitha",
		CannotReverse = "La yumkinuk al-tarafiu an hadha.",
		Cancel = "Ilgha",
		Confirm = "Taakid",
		Select = "Ikhtar...",
		TypePlaceholder = "Uktub...",
		SearchPlaceholder = "Bahth...",
		Done = "Tamm",
		None = "La shay",
		SelectedCount = "%d mukhtar",
		TypeOrPaste = "Uktub aw alsiq huna...",
	},
	tr = {
		CloseWindow = "Pencereyi kapat",
		CannotReverse = "Bunu geri alamazsiniz.",
		Cancel = "Iptal",
		Confirm = "Onayla",
		Select = "Sec...",
		TypePlaceholder = "Yaz...",
		...
		Done = "Tamam",
		None = "Yok",
		SelectedCount = "%d secildi",
		TypeOrPaste = "Buraya yazin veya yapistirin...",
	},
	pl = {
		CloseWindow = "Zamknij okno",
		CannotReverse = "Nie mozesz tego cofnac.",
		Cancel = "Anuluj",
		Confirm = "Potwierdz",
		Select = "Wybierz...",
		TypePlaceholder = "Wpisz...",
		SearchPlaceholder = "Szukaj...",
		Done = "Gotowe",
		None = "Brak",
		SelectedCount = "Wybrano %d",
		TypeOrPaste = "Wpisz lub wklej tutaj...",
	},
	nl = {
		CloseWindow = "Venster sluiten",
		CannotReverse = "Dit kan niet ongedaan worden gemaakt.",
		Cancel = "Annuleren",
		Confirm = "Bevestigen",
		Select = "Selecteer...",
		TypePlaceholder = "Typ...",
		...
		Done = "Klaar",
		None = "Geen",
		SelectedCount = "%d geselecteerd",
		TypeOrPaste = "Typ of plak hier...",
	},
	sv = {
		CloseWindow = "Stang fonster",
		CannotReverse = "Du kan inte angra detta.",
		Cancel = "Avbryt",
		Confirm = "Bekrafta",
		Select = "Valj...",
		TypePlaceholder = "Skriv...",
		SearchPlaceholder = "Sok...",
		Done = "Klar",
		None = "Ingen",
		SelectedCount = "%d valda",
		TypeOrPaste = "Skriv eller klistra in har...",
	},
	no = {
		CloseWindow = "Lukk vindu",
		CannotReverse = "Du kan ikke angre dette.",
		Cancel = "Avbryt",
		Confirm = "Bekreft",
		Select = "Velg...",
		TypePlaceholder = "Skriv...",
		...
		Done = "Ferdig",
		None = "Ingen",
		SelectedCount = "%d valgt",
		TypeOrPaste = "Skriv eller lim inn her...",
	},
	da = {
		CloseWindow = "Luk vindue",
		CannotReverse = "Du kan ikke fortryde dette.",
		Cancel = "Annuller",
		Confirm = "Bekraeft",
		Select = "Vaelg...",
		TypePlaceholder = "Skriv...",
		...
		None = "Ingen",
		SelectedCount = "%d valgt",
		TypeOrPaste = "Skriv eller saet ind her...",
	},
	fi = {
		CloseWindow = "Sulje ikkuna",
		CannotReverse = "Et voi perua tata.",
		Cancel = "Peruuta",
		Confirm = "Vahvista",
		Select = "Valitse...",
		TypePlaceholder = "Kirjoita...",
		SearchPlaceholder = "Hae...",
		Done = "Valmis",
		None = "Ei mitaan",
		SelectedCount = "%d valittu",
		TypeOrPaste = "Kirjoita tai liita tahan...",
	},
	cs = {
		CloseWindow = "Zavrit okno",
		CannotReverse = "Toto nelze vratit zpet.",
		Cancel = "Zrusit",
		Confirm = "Potvrdit",
		Select = "Vybrat...",
		TypePlaceholder = "Zadejte...",
		SearchPlaceholder = "Hledat...",
		Done = "Hotovo",
		None = "Zadne",
		SelectedCount = "%d vybrano",
		TypeOrPaste = "Zadejte nebo vlozte zde...",
	},
	hu = {
		CloseWindow = "Ablak bezarasa",
		CannotReverse = "Ezt nem lehet visszavonni.",
		Cancel = "Megse",
		Confirm = "Megerogenes",
		Select = "Valasztas...",
		TypePlaceholder = "Irjon...",
		SearchPlaceholder = "Kereses...",
		Done = "Kesz",
		None = "Nincs",
		SelectedCount = "%d kivalasztva",
		TypeOrPaste = "Irjon vagy illesszen be ide...",
	},
	ro = {
		CloseWindow = "Inchide fereastra",
		CannotReverse = "Nu poti anula aceasta actiune.",
		Cancel = "Anuleaza",
		Confirm = "Confirma",
		Select = "Selecteaza...",
		TypePlaceholder = "Scrie...",
		SearchPlaceholder = "Cauta...",
		Done = "Gata",
		None = "Niciunul",
		SelectedCount = "%d selectate",
		TypeOrPaste = "Scrie sau lipeste aici...",
	},
	uk = {
		CloseWindow = "Zakryty vikno",
		CannotReverse = "Tse ne mozhna skasuvaty.",
		Cancel = "Skasuvaty",
		Confirm = "Pidtverdyty",
		Select = "Vybraty...",
		TypePlaceholder = "Vvedit...",
		SearchPlaceholder = "Poshuk...",
		Done = "Hotovo",
		None = "Nemae",
		SelectedCount = "%d vybrano",
		TypeOrPaste = "Vvedit abo vstavte tut...",
	},
	vi = {
		CloseWindow = "Dong cua so",
		CannotReverse = "Ban khong the hoan tac viec nay.",
		Cancel = "Huy",
		Confirm = "Xac nhan",
		Select = "Chon...",
		TypePlaceholder = "Nhap...",
		SearchPlaceholder = "Tim kiem...",
		Done = "Xong",
		None = "Khong",
		SelectedCount = "Da chon %d",
		TypeOrPaste = "Nhap hoac dan vao day...",
	},
	th = {
		CloseWindow = "Pit nataang",
		CannotReverse = "Khun mai samat yoksik dai.",
		Cancel = "Yokleik",
		Confirm = "Yuenyan",
		Select = "Leuak...",
		TypePlaceholder = "Pim...",
		SearchPlaceholder = "Khonha...",
		Done = "Set",
		None = "Mai mee",
		SelectedCount = "Leuak %d rai",
		TypeOrPaste = "Pim rue wangtong ti ni...",
	},
	id = {
		CloseWindow = "Tutup jendela",
		CannotReverse = "Anda tidak dapat membatalkan ini.",
		Cancel = "Batal",
		Confirm = "Konfirmasi",
		Select = "Pilih...",
		...
		TypeOrPaste = "Ketik atau tempel di sini...",
	},
	ms = {
		CloseWindow = "Tutup tetingkap",
		CannotReverse = "Anda tidak boleh membatalkan ini.",
		Cancel = "Batal",
		Confirm = "Sahkan",
		Select = "Pilih...",
		TypePlaceholder = "Taip...",
		SearchPlaceholder = "Cari...",
		Done = "Selesai",
		None = "Tiada",
		SelectedCount = "%d dipilih",
		TypeOrPaste = "Taip atau tampal di sini...",
	},
	hi = {
		CloseWindow = "Window band karein",
		CannotReverse = "Aap ise vapas nahi le sakte.",
		Cancel = "Radd karen",
		Confirm = "Pushit karen",
		Select = "Chunein...",
		TypePlaceholder = "Likhein...",
		SearchPlaceholder = "Khojein...",
		Done = "Ho gaya",
		None = "Kuch nahi",
		SelectedCount = "%d chuna gaya",
		TypeOrPaste = "Yahan likhein ya chipkayein...",
	},
	bn = {
		CloseWindow = "Window bondho korun",
		CannotReverse = "Apni eta ferot nite parben na.",
		Cancel = "Batil",
		Confirm = "Nishchit korun",
		Select = "Bachun...",
		TypePlaceholder = "Likhun...",
		SearchPlaceholder = "Khujun...",
		Done = "Shesh",
		None = "Kichu nei",
		SelectedCount = "%d niranito",
		TypeOrPaste = "Ekhane likhun ba paste korun...",
	},
	el = {
		CloseWindow = "Kleise parathiro",
		CannotReverse = "Den mporeis na to anairesis.",
		Cancel = "Akrosi",
		Confirm = "Epivevaiosi",
		Select = "Epilogi...",
		TypePlaceholder = "Grapse...",
		SearchPlaceholder = "Anazitisi...",
		Done = "Oloklirothike",
		None = "Kanena",
		SelectedCount = "%d epilegmena",
		TypeOrPaste = "Grapse i epikollise edo...",
	},
	he = {
		CloseWindow = "Sgor chalonn",
		CannotReverse = "I efshar levatel et ze.",
		Cancel = "Bitul",
		Confirm = "Ishur",
		Select = "Bechor...",
		TypePlaceholder = "Haktav...",
		SearchPlaceholder = "Chipus...",
		Done = "Siym",
		None = "Ein",
		SelectedCount = "%d nivcharu",
		TypeOrPaste = "Haktav o hadvek kan...",
	},
}

function LeehHub:SetLanguage(code)
	if type(code) ~= "string" then return false end
	code = string.lower(code)
	if not LeehHub.Translations[code] then return false end
	LeehHub.CurrentLanguage = code
	for _, window in ipairs(LeehHub.Windows) do
		if window and window.ApplyLanguage then
...
function LeehHub:GetLanguage()
	return LeehHub.CurrentLanguage
end

function LeehHub:T(key, ...)
	local lang = LeehHub.Translations[LeehHub.CurrentLanguage] or LeehHub.Translations.en
	local str = lang[key] or (LeehHub.Translations.en[key]) or key
	if select("#", ...) > 0 then
...
function LeehHub:Translate(text)
	if type(text) ~= "string" or text == "" then return text end
	local lang = LeehHub.Translations[LeehHub.CurrentLanguage]
	if not lang then return text end
	for k, v in pairs(lang) do
		if k == text or v == text then
			return v
		end
	end
	return text
...
local function TryCreateBackgroundBlur(parent, size, transparency)
	local ok, blur = pcall(function()
		local b = Instance.new("BackgroundBlur")
		b.Name = "LeehAcrylicBlur"
		b.Size = size or 22
		if transparency then b.Transparency = transparency end
		b.Parent = parent
		return b
	end)
	if ok and blur then return blur end
	return nil
end

local function ApplyAcrylicEffect(frame, baseTransparency, cornerRadius)
	if not frame then return false end
	local realBlur = TryCreateBackgroundBlur(frame, 24, 0.1)
	if realBlur then
		frame.BackgroundTransparency = math.clamp((baseTransparency or 0.2) + 0.28, 0, 0.95)
		return true
	end

	frame.BackgroundTransparency = math.clamp((baseTransparency or 0.2) + 0.05, 0, 0.9)

	local frost1 = Instance.new("Frame")
	frost1.Name = "LeehAcrylicFrost1"
	frost1.Size = UDim2.fromScale(1, 1)
	frost1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	frost1.BackgroundTransparency = 0.93
	frost1.BorderSizePixel = 0
	frost1.ZIndex = (frame.ZIndex or 1)
	frost1.Parent = frame
	if cornerRadius then AddCorner(cornerRadius, frost1) end
	...
	frost2.Name = "LeehAcrylicFrost2"
	frost2.Size = UDim2.fromScale(1, 1)
	frost2.BackgroundColor3 = Color3.fromRGB(10, 10, 14)
	frost2.BackgroundTransparency = 0.85
	frost2.BorderSizePixel = 0
	frost2.ZIndex = (frame.ZIndex or 1)
	frost2.Parent = frame
	if cornerRadius then AddCorner(cornerRadius, frost2) end
	...
	AddGlassShine(frame, cornerRadius)
	return false
end
...
function LeehHub:CreateWindow(config)
	...
	local acrylicEnabled = config.Acrylic == true
	if type(config.Language) == "string" and LeehHub.Translations[string.lower(config.Language)] then
		LeehHub.CurrentLanguage = string.lower(config.Language)
	end
	...
	local usingRealBlur = false
	if acrylicEnabled then
		usingRealBlur = ApplyAcrylicEffect(MainFrame, mainBgTrans, 12)
	elseif not hasBackground then
	...
	if acrylicEnabled then
		ApplyAcrylicEffect(ThemePopup, hasBackground and 0.55 or 0.22, 10)
	elseif not hasBackground then
		AddGlassShine(ThemePopup, 10)
	end
	...
	CloseConfirmOverlay.BackgroundColor3 = Color3.new(0, 0, 0)
	CloseConfirmOverlay.BackgroundTransparency = 0.45
	CloseConfirmOverlay.Visible = false
	CloseConfirmOverlay.ZIndex = 90
	CloseConfirmOverlay.Parent = MainFrame

	local CloseConfirmPopup = Instance.new("Frame")
	CloseConfirmPopup.Size = UDim2.fromOffset(280, 150)
	CloseConfirmPopup.Position = UDim2.fromScale(0.5, 0.5)
	CloseConfirmPopup.AnchorPoint = Vector2.new(0.5, 0.5)
	CloseConfirmPopup.BackgroundColor3 = Theme.ElementBackground
	CloseConfirmPopup.BackgroundTransparency = 0.08
	CloseConfirmPopup.ZIndex = 91
	CloseConfirmPopup.Parent = CloseConfirmOverlay
	AddCorner(12, CloseConfirmPopup)
	AddStroke(CloseConfirmPopup, Theme.Outline, 2.5, 0.1)
	if acrylicEnabled then
		ApplyAcrylicEffect(CloseConfirmPopup, 0.08, 12)
	elseif not hasBackground then
		AddGlassShine(CloseConfirmPopup, 12)
	end

	local CloseConfirmTitle = Instance.new("TextLabel")
	CloseConfirmTitle.Size = UDim2.new(1, -24, 0, 28)
	CloseConfirmTitle.Position = UDim2.new(0, 12, 0, 14)
	CloseConfirmTitle.BackgroundTransparency = 1
	CloseConfirmTitle.Text = LeehHub:T("CloseWindow")
	...
	CloseConfirmTitle.ZIndex = 92
	CloseConfirmTitle.Parent = CloseConfirmPopup

	local CloseConfirmMsg = Instance.new("TextLabel")
	CloseConfirmMsg.Size = UDim2.new(1, -24, 0, 36)
	CloseConfirmMsg.Position = UDim2.new(0, 12, 0, 46)
	CloseConfirmMsg.BackgroundTransparency = 1
	CloseConfirmMsg.Text = LeehHub:T("CannotReverse")
	CloseConfirmMsg.Font = Enum.Font.Gotham
	CloseConfirmMsg.TextSize = 13
	CloseConfirmMsg.TextColor3 = Theme.Placeholder
	CloseConfirmMsg.TextXAlignment = Enum.TextXAlignment.Left
	CloseConfirmMsg.TextWrapped = true
	CloseConfirmMsg.ZIndex = 92
	CloseConfirmMsg.Parent = CloseConfirmPopup

	local CloseCancelBtn = Instance.new("TextButton")
	CloseCancelBtn.Size = UDim2.fromOffset(100, 32)
	CloseCancelBtn.Position = UDim2.new(0, 16, 1, -48)
	CloseCancelBtn.BackgroundColor3 = Elevate(Theme.ElementBackground)
	CloseCancelBtn.Text = LeehHub:T("Cancel")
	CloseCancelBtn.Font = Enum.Font.GothamBold
	CloseCancelBtn.TextSize = 13
	CloseCancelBtn.TextColor3 = Theme.Text
	CloseCancelBtn.ZIndex = 92
	CloseCancelBtn.Parent = CloseConfirmPopup
	AddCorner(8, CloseCancelBtn)
	AddStroke(CloseCancelBtn, Theme.Outline, 1.5, 0.25)

	local CloseConfirmBtn = Instance.new("TextButton")
	CloseConfirmBtn.Size = UDim2.fromOffset(100, 32)
	CloseConfirmBtn.Position = UDim2.new(1, -116, 1, -48)
	CloseConfirmBtn.BackgroundColor3 = Theme.Accent
	CloseConfirmBtn.Text = LeehHub:T("Confirm")
	CloseConfirmBtn.Font = Enum.Font.GothamBold
	CloseConfirmBtn.TextSize = 13
	CloseConfirmBtn.TextColor3 = Theme.Text
	CloseConfirmBtn.ZIndex = 92
	CloseConfirmBtn.Parent = CloseConfirmPopup
	AddCorner(8, CloseConfirmBtn)

	CloseCancelBtn.MouseButton1Click:Connect(function()
		CloseConfirmOverlay.Visible = false
	end)
	...
	local function UpdateTheme(name, animate)
		...
		local function Apply()
			...
			if T.Name == "Matrix" and not hasBackground and not acrylicEnabled then
	...
	function Window:SetAcrylic(enabled)
		acrylicEnabled = enabled and true or false
		local existing = MainFrame:FindFirstChild("LeehAcrylicBlur") or MainFrame:FindFirstChild("LeehAcrylicFrost1") or MainFrame:FindFirstChild("LeehAcrylicFrost2")
		if existing then existing:Destroy() end
		local f2 = MainFrame:FindFirstChild("LeehAcrylicFrost2")
		if f2 then f2:Destroy() end
		if acrylicEnabled then
			ApplyAcrylicEffect(MainFrame, panelTransparency, 12)
		else
			MainFrame.BackgroundTransparency = mainBgTrans
			if not hasBackground and not MainFrame:FindFirstChild("GlassShine") then
				AddGlassShine(MainFrame, 12)
			end
		end
	end
	...
	function Window:SetLanguage(code)
		return LeehHub:SetLanguage(code)
	end

	function Window:ApplyLanguage()
		if CloseConfirmTitle then CloseConfirmTitle.Text = LeehHub:T("CloseWindow") end
		if CloseConfirmMsg then CloseConfirmMsg.Text = LeehHub:T("CannotReverse") end
		if CloseCancelBtn then CloseCancelBtn.Text = LeehHub:T("Cancel") end
		if CloseConfirmBtn then CloseConfirmBtn.Text = LeehHub:T("Confirm") end
		for _, item in ipairs(Registered) do
			if item.Type == "Element" and item.SubText and item.SubText:IsA("TextBox") then
				if item.SubText.PlaceholderText == "Type..." or item.SubText.PlaceholderText == LeehHub.Translations.en.TypePlaceholder then
					item.SubText.PlaceholderText = LeehHub:T("TypePlaceholder")
				elseif item.SubText.PlaceholderText == "Type or paste here..." or item.SubText.PlaceholderText == LeehHub.Translations.en.TypeOrPaste then
					item.SubText.PlaceholderText = LeehHub:T("TypeOrPaste")
				elseif item.SubText.PlaceholderText == "Search..." or item.SubText.PlaceholderText == LeehHub.Translations.en.SearchPlaceholder then
					item.SubText.PlaceholderText = LeehHub:T("SearchPlaceholder")
				end
			end
		end
	end
	...
	function Window:Dialog(config)
		...
		local buttons = config.Buttons or { { Title = LeehHub:T("Confirm"), Callback = nil } }
		...
		if acrylicEnabled then
			ApplyAcrylicEffect(Popup, 0.06, 12)
		else
		...
		for _, b in ipairs(buttons) do
			...
			bBtn.BackgroundColor3 = b.Primary and Theme.Accent or Elevate(Theme.ElementBackground)
			...
			bBtn.Parent = btnRow
			AddCorner(8, bBtn)
			if not b.Primary then AddStroke(bBtn, Theme.Outline, 1.5, 0.25) end
			bBtn.MouseButton1Click:Connect(function()
				if b.Callback then
					local ok = pcall(b.Callback)
				end
	...
	function Window:CreateTab(tabConfig, maybeIcon)
		...
		function Tab:CreateSection(secConfig)
			...
			function Section:CreateToggle(tConfig)
				...
				local flag = c.Flag
				local buttonCfg = c.Button or c.ExtraButton
				...
				local extraBtnWidth = buttonCfg and (buttonCfg.Width or 28) or 0
				local extraBtnGap = buttonCfg and 8 or 0

				local lbl = Instance.new("TextLabel")
				lbl.Size = UDim2.new(1, -70 - extraBtnWidth - extraBtnGap, 1, 0)
				...
				local extraBtn, extraBtnStroke, extraBtnIcon
				if buttonCfg then
					extraBtn = Instance.new("TextButton")
					extraBtn.Size = UDim2.fromOffset(extraBtnWidth, 26)
					extraBtn.Position = UDim2.new(1, -54 - extraBtnGap - extraBtnWidth, 0.5, -13)
					extraBtn.BackgroundColor3 = Elevate(Theme.ElementBackground)
					extraBtn.AutoButtonColor = false
					extraBtn.Text = (not buttonCfg.Icon) and (buttonCfg.Text or "") or ""
					extraBtn.Font = Enum.Font.GothamBold
					extraBtn.TextSize = 11
					extraBtn.TextColor3 = Theme.Text
					extraBtn.ZIndex = 8
					extraBtn.Parent = row
					AddCorner(6, extraBtn)
					extraBtnStroke = AddStroke(extraBtn, Theme.Outline, 1.5, 0.3)
					if buttonCfg.Icon then
						extraBtnIcon = AddImage(extraBtn, buttonCfg.Icon, UDim2.fromOffset(14, 14), Theme.Icon, 0, 9)
						if extraBtnIcon then
							extraBtnIcon.AnchorPoint = Vector2.new(0.5, 0.5)
							extraBtnIcon.Position = UDim2.fromScale(0.5, 0.5)
						end
					end
					extraBtn.MouseEnter:Connect(function()
						TW(extraBtn, 0.12, { BackgroundColor3 = Elevate(Theme.ElementBackground, 0.12) })
					end)
					extraBtn.MouseLeave:Connect(function()
						TW(extraBtn, 0.12, { BackgroundColor3 = Elevate(Theme.ElementBackground) })
					end)
				...
				click.Size = UDim2.new(1, -(extraBtnWidth + extraBtnGap), 1, 0)
				...
				local toggleExtras = {}
				if extraBtn then
					table.insert(toggleExtras, {Kind = "Elevated", Object = extraBtn})
					table.insert(toggleExtras, {Kind = "Outline", Object = extraBtnStroke})
					if extraBtnIcon then table.insert(toggleExtras, {Kind = "Icon", Object = extraBtnIcon}) end
					if extraBtn.Text ~= "" then table.insert(toggleExtras, {Kind = "Text", Object = extraBtn}) end
				end

				table.insert(Registered, { Type = "Element", Instance = row, Stroke = stroke, Label = lbl, Icon = elementIcon, SubColor = switch, State = function() return state end, Extras = #toggleExtras > 0 and toggleExtras or nil })
			...
			function Section:CreateRangeSlider(rConfig)
				...
				local row, stroke = RegisterRow(62)
				row.Parent = container
				ApplyDependsOn(row, c)
				...
				local valBox = Instance.new("Frame")
				valBox.Size = UDim2.fromOffset(86, 20)
				valBox.Position = UDim2.new(1, -98, 0, 4)
				valBox.BackgroundColor3 = Elevate(Theme.ElementBackground)
				valBox.BackgroundTransparency = hasBackground and 0.4 or 0.15
				valBox.ZIndex = 7
				valBox.Parent = row
				AddCorner(6, valBox)
				...
				track.BackgroundColor3 = Elevate(Theme.ElementBackground)
				track.BackgroundTransparency = hasBackground and 0.35 or 0
				track.ZIndex = 7
				track.Parent = row
				AddCorner(4, track)
				...
				local function makeKnob()
					...
					k.Parent = track
					AddCorner(8, k)
					AddStroke(k, Theme.Slider or Theme.Accent, 2, 0)
					return k
				end

				local knobLow = makeKnob()
				local knobHigh = makeKnob()
				...
				local function redraw()
					...
					fill.Size = UDim2.new(math.max(0, tHigh - tLow), 0, 1, 0)
				...
				table.insert(Registered, { Type = "Element", Instance = row, Stroke = stroke, Label = lbl, Icon = elementIcon, SubColor = fill, SubRole = "Slider", Extras = {{Kind = "Text", Object = valLbl}, {Kind = "Elevated", Object = valBox}, {Kind = "Elevated", Object = track}} })
			...
			function Section:CreateButton(bConfig)
				...
				local callback = c.Callback or function() end
				local customColor = c.Color or c.ButtonColor or c.BackgroundColor
				if type(customColor) == "string" then
					local ok, col = pcall(function() return Color3.fromHex(customColor) end)
					if ok then customColor = col else customColor = nil end
				elseif typeof(customColor) ~= "Color3" then
					customColor = nil
				end
				local baseColor = customColor or Elevate(Theme.ElementBackground)
				local hoverColor = customColor and Elevate(customColor, 0.12) or (Theme.Toggle or Color3.fromRGB(220, 40, 40))
				...
				btn.MouseEnter:Connect(function()
					TW(btn, 0.12, { BackgroundColor3 = hoverColor })
				end)
				btn.MouseLeave:Connect(function()
					TW(btn, 0.12, { BackgroundColor3 = baseColor })
				end)
				btn.MouseButton1Click:Connect(function()
					callback()
				end)

				table.insert(Registered, { Type = "Element", Instance = btn, Stroke = stroke, Label = btn, Icon = elementIcon, CustomButtonColor = customColor })
			end
			...
			function Section:CreateDropdown(dConfig)
				...
				local function formatSelected()
					if multi then
						...
						if #parts == 0 then return LeehHub:T("Select") end
						if #parts <= 2 then return table.concat(parts, ", ") end
						return LeehHub:T("SelectedCount", #parts)
					end
					return selected ~= nil and tostring(selected) or LeehHub:T("Select")
				end
			...
			function Section:CreateInput(iConfig)
				...
				local placeholder = c.Placeholder or LeehHub:T("TypePlaceholder")
			...
			function Section:CreateTextArea(taConfig)
				...
				local placeholder = c.Placeholder or LeehHub:T("TypeOrPaste")
				local default = c.Default or c.Value or ""
				local height = c.Height or 100
				local callback = c.Callback or function() end

				local container2 = Instance.new("Frame")
				container2.Size = UDim2.new(1, 0, 0, height + 38)
				...
				boxFrame.Position = UDim2.new(0, 10, 0, 30)
				boxFrame.BackgroundColor3 = Elevate(Theme.ElementBackground)
				boxFrame.BackgroundTransparency = hasBackground and 0.35 or 0.08
				boxFrame.ScrollBarThickness = 3
				boxFrame.ScrollBarImageColor3 = Theme.Outline
				boxFrame.ScrollBarImageTransparency = 0.35
				boxFrame.BorderSizePixel = 0
				boxFrame.CanvasSize = UDim2.new(0, 0, 0, 0)
				boxFrame.AutomaticCanvasSize = Enum.AutomaticSize.Y
				boxFrame.ZIndex = 7
				boxFrame.Parent = container2
				AddCorner(7, boxFrame)
				local boxStroke = AddStroke(boxFrame, Theme.Outline, 1, hasBackground and 0.45 or 0.25)
				...
				table.insert(Registered, { Type = "Element", Instance = container2, Stroke = stroke2, Label = lbl, Icon = elementIcon, Extras = {{Kind = "Elevated", Object = boxFrame}, {Kind = "Outline", Object = boxStroke}, {Kind = "Text", Object = box}, {Kind = "Placeholder", Object = box}} })
			...
			function Section:CreateKeybind(kConfig)
				...
				keyBtn.Text = default and default.Name or LeehHub:T("None")
				...
				function obj:Set(k)
					current = k
					keyBtn.Text = k and k.Name or LeehHub:T("None")
				end
		...
		function Tab:CreateSearch(sConfig)
			local c = NormalizeArgs(sConfig) or {}
			local placeholder = c.Placeholder or c.PlaceholderText or LeehHub:T("SearchPlaceholder")
...
function LeehHub:Notify(config)
	...
	if buttons and #buttons > 0 then
		...
		btnRow.Size = UDim2.new(1, -56, 0, 26)
		btnRow.Position = UDim2.new(0, 44, 0, 58)
		btnRow.BackgroundTransparency = 1
		btnRow.Parent = frame
		...
		for _, b in ipairs(buttons) do
			...
			nBtn.Size = UDim2.fromOffset(0, 24)
			nBtn.AutomaticSize = Enum.AutomaticSize.X
			nBtn.BackgroundColor3 = b.Primary and accent or Elevate(T.ElementBackground)
			nBtn.Text = "  " .. (b.Text or "Ok") .. "  "
			nBtn.Font = Enum.Font.GothamBold
			nBtn.TextSize = 11
			nBtn.TextColor3 = T.Text
			nBtn.Parent = btnRow
			AddCorner(6, nBtn)
			nBtn.MouseButton1Click:Connect(function()
				if b.Callback then pcall(b.Callback) end
				if b.CloseOnClick ~= false and frame.Parent then
					frame:Destroy()
				end
			end)
		end
	...
	TweenService:Create(frame, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
		Size = UDim2.new(1, 0, 0, buttons and #buttons > 0 and 92 or 72)
	}):Play()
